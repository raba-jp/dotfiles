...
let
  ...
  keysGnomeWm = "org/gnome/desktop/wm/keybindings";
  keysGnomeShell = "org/gnome/shell/keybindings";
  keysMutter = "org/gnome/mutter/keybindings";
  keysMedia = "org/gnome/settings-daemon/plugins/media-keys";
  keysMutterWaylandRestore = "org/gnome/mutter/wayland/keybindings/restore-shortcuts";
in
