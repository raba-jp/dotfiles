  ...
  programs.neovim = {
    ...
    plugins = [
      ...
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "dressing.nvim";
          src = args.dressing-nvim;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "nightfox.nvim";
          src = args.nightfox-nvim;
        };
      }
      ...
      # { plugin = (pkgs.vimPlugins.nvim-treesitter.withPlugins (_: pkgs.tree-sitter.allGrammars)); }
      {
        plugin = buildVimPluginFrom2Nix {
          ...
          src = args.nvim-treesitter-context;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "telescope.nvim";
          src = args.telescope-nvim;
        };
      }
      {
        plugin = buildVimPlugin {
          name = "telescope-fzf-native.nvim";
          src = args.telescope-fzf-native-nvim;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "telescope-ghq.nvim";
          src = args.telescope-ghq-nvim;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "legendary.nvim";
          src = args.legendary-nvim;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "lualine.nvim";
          src = args.lualine-nvim;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
      ...
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "cmp-cmdline";
          src = args.cmp-cmdline;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "cmp-nvim-lsp-document-symbol";
          src = args.cmp-nvim-lsp-document-symbol;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "cmp-nvim-lsp-signature-help";
          src = args.cmp-nvim-lsp-signature-help;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "lspkind-nvim";
          src = args.lspkind-nvim;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
      ...
      }
      {
        plugin = buildVimPluginFrom2Nix {
          ...
          src = args.lsp-format-nvim;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "nvim-lspconfig";
          src = args.nvim-lspconfig;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "nvim-notify";
          src = args.nvim-notify;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "gitsigns-nvim";
          src = args.gitsigns-nvim;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "lspsaga.nvim";
          src = args.lspsaga-nvim;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
          name = "impatient.nvim";
          src = args.impatient-nvim;
        };
      }
      {
        plugin = buildVimPluginFrom2Nix {
